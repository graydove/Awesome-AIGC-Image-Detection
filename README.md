...
There is a new AIGC image detection benchmark that includes six datasets and ten detection methods. All results are obtained by running the official code, and more details will be provided soon.
